...
export default function ResearchPage() {
  ...
  if (fetchError) {
    return <div role="alert" className="mx-auto mt-16 max-w-lg text-center"><h1 className="text-xl font-bold text-red-400">Unable to load research data</h1><p className="mt-1 text-sm text-ink/50">{fetchError}</p></div>;
  }
  if (protocols === null) {
