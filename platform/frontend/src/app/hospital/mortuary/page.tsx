...
export default function MortuaryPage() {
  ...
  if (fetchError) {
    return <div className="mx-auto mt-16 max-w-lg text-center"><h1 className="text-xl font-bold text-red-400">Unable to load mortuary cases</h1><p className="mt-1 text-sm text-ink/50">{fetchError}</p></div>;
  }
  if (cases === null) {
