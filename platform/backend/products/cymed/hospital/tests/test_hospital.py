...
class TestHospitalEdition:
    def test_adt_admission_transfer_discharge_flow(
    ...
    def test_emergency_visit_triage_acuity_and_alerts(
        ...
        visit_resp = auth_client.post(
            "/api/v1/hospital/emergency/visits/",
            {
                ...
                "presenting_complaint": "Severe dyspnea",
                "status": "triage",
            },
            format="json",
        )
        ...
        triage_resp = auth_client.post(
            "/api/v1/hospital/emergency/triage/",
            {
                ...
                "triage_nurse_id": str(uuid.uuid4()),
            },
            format="json",
        )
        ...
        disp_resp = auth_client.post(
            "/api/v1/hospital/emergency/dispositions/",
            {
                ...
                "notes": "Transferred to Cardiac ICU",
            },
            format="json",
        )
    ...
    def test_inpatient_stay_and_daily_rounds(self, auth_client, test_tenant_id, setup_base_data):
        adm_reason = AdmissionReason.objects.create(
            tenant_id=test_tenant_id, name="Dyspnea", code="R-ADM-002"
        )
        adm_type = AdmissionType.objects.create(
            tenant_id=test_tenant_id, name="Routine", code="T-ADM-002"
        )
        adm = Admission.objects.create(
            ...
            admitting_physician_id=uuid.uuid4(),
            status="admitted",
        )
        ...
        stay_resp = auth_client.post(
            ...
            {
                "admission": adm.id,
                "care_team_leader_id": str(uuid.uuid4()),
                "expected_length_of_stay": 4,
            },
            format="json",
        )
        ...
        round_resp = auth_client.post(
            "/api/v1/hospital/inpatient/rounds/",
            {
                ...
                "subjective_notes": "Chest pain resolved",
                "objective_notes": "Vitals stable",
                "assessment_notes": "Improving",
                "plan_notes": "Discharge tomorrow",
            },
            format="json",
        )
        ...
        plan_resp = auth_client.post(
            ...
            {
                "stay": stay_id,
                "target_discharge_date": "2026-06-25",
    ...
    def test_nursing_shifts_and_tasks(self, auth_client, test_tenant_id, setup_base_data):
        adm_reason = AdmissionReason.objects.create(
            tenant_id=test_tenant_id, name="Asthma", code="R-ADM-NUR-01"
        )
        adm_type = AdmissionType.objects.create(
            tenant_id=test_tenant_id, name="Elective", code="T-ADM-NUR-01"
        )
        adm = Admission.objects.create(
            tenant_id=test_tenant_id,
            encounter=setup_base_data["encounter"],
        ...
        assess_resp = auth_client.post(
            ...
            {
                "admission": adm.id,
                "assessed_by": str(uuid.uuid4()),
                "nursing_summary": "Patient stable, lungs clear",
            },
            format="json",
        )
        ...
        cp_resp = auth_client.post(
            ...
            {
                "admission": adm.id,
                "goals": "Prevent exacerbation",
                "activities": "Inhaler schedule, positioning",
            },
            format="json",
        )
        assert cp_resp.status_code == 201
        ...
        task_patch = auth_client.patch(
            f"/api/v1/hospital/nursing/tasks/{task_id}/", {"status": "completed"}, format="json"
        )
    ...
    def test_icu_stays_and_critical_events(self, auth_client, test_tenant_id, setup_base_data):
        ...
        adm_reason = AdmissionReason.objects.create(
            tenant_id=test_tenant_id, name="Cardiac Arrest", code="R-ADM-ICU-01"
        )
        adm_type = AdmissionType.objects.create(
            tenant_id=test_tenant_id, name="ICU Direct", code="T-ADM-ICU-01"
        )
        adm = Admission.objects.create(
            tenant_id=test_tenant_id,
            encounter=setup_base_data["encounter"],
        ...
        crit_resp = auth_client.post(
            ...
            {
                "icu_stay": icu_id,
                "event_type": "vent_failure",
                "details": "Vent disconnected",
                "actions_taken": "Reconnected and sealed",
            },
            format="json",
        )
    ...
    def test_operating_room_surgical_case_flow(self, auth_client, test_tenant_id, setup_base_data):
        ...
        sched_resp = auth_client.post(
            "/api/v1/hospital/or/schedules/",
            {
                ...
                "operating_room_id": str(uuid.uuid4()),
                "allocated_date": "2026-06-23",
            },
            format="json",
        )
        ...
        consent_resp = auth_client.post(
            ...
            {
                "surgical_case": case_id,
                "patient_signature_blob": "Base64==",
                "witness_name": "Nurse Kelly",
            },
            format="json",
        )
        ...
        patch_resp = auth_client.patch(
            f"/api/v1/hospital/or/cases/{case_id}/", {"status": "completed"}, format="json"
        )
    ...
    def test_anesthesia_records_and_aldrete_scoring(
        self, auth_client, test_tenant_id, setup_base_data
    ):
        patient = setup_base_data["patient"]
        ...
        plan_resp = auth_client.post(
            ...
            {
                "surgical_case": case.id,
                "anesthetic_type": "general",
                "plan_description": "Propofol induction",
            },
            format="json",
        )
        assert plan_resp.status_code == 201
        ...
        rec_resp = auth_client.post(
            ...
            {
                "surgical_case": case.id,
                "anesthesiologist_id": str(uuid.uuid4()),
                "start_time": timezone.now().isoformat(),
                "agents_used": ["Propofol", "Sevoflurane"],
    ...
    def test_maternity_records_and_newborn(self, auth_client, test_tenant_id, setup_base_data):
        ...
        labor_resp = auth_client.post(
            "/api/v1/hospital/maternity/labor-episodes/",
            {
                ...
                "fetal_monitoring_status": "normal",
            },
            format="json",
        )
    ...
    def test_transfer_center_and_referrals(self, auth_client, test_tenant_id, setup_base_data):
        ...
        case_resp = auth_client.post(
            ...
            {
                "patient": str(patient.id),
                "source_hospital_name": "Al-Khalidi Hospital",
                "target_facility": fac_id,
                "reason": "Oncology evaluation",
            },
            format="json",
        )
        assert case_resp.status_code == 201
    ...
    def test_discharge_medication_validations(self, auth_client, test_tenant_id, setup_base_data):
        adm_reason = AdmissionReason.objects.create(
            tenant_id=test_tenant_id, name="Dyspnea", code="R-ADM-003"
        )
        adm_type = AdmissionType.objects.create(
            tenant_id=test_tenant_id, name="Emergency", code="T-ADM-003"
        )
        adm = Admission.objects.create(
            tenant_id=test_tenant_id,
            encounter=setup_base_data["encounter"],
        ...
        med_resp = auth_client.post(
            ...
            {
                "stay": stay.id,
                "medication_code": "111553001",
                "reconciliation_action": "continued",
                "notes": "Daily",
            },
            format="json",
        )
        ...
        inst_resp = auth_client.post(
            ...
            {
                "stay": stay.id,
                "dietary_instructions": "Low fat",
                "warning_symptoms": "Return if chest pain recurs",
            },
            format="json",
        )
    ...
    def test_capacity_management_surge_planning(self, auth_client, test_tenant_id, setup_base_data):
        ...
        rule_resp = auth_client.post(
            ...
            {
                "rule_name": "Quarantine Surge",
                "metric_source": "census",
                "threshold_value": 90,
                "action_plan_name": "Overflow Protocol",
            },
            format="json",
        )
        ...
        surge_resp = auth_client.post(
            ...
            {
                "name": "Mass Casualty L1",
                "trigger_condition": "5+ critical",
